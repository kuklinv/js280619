...
// использование динамических ключей/ это удобно когда не знаешь какой ключ придет
// перебирать массив например юзеров  - довольно затратно 
// проще работать с обьектами - можно получать значения  через свойства
//      !!!! использовать обьекты везде где массив слишком большой!! это рефакторинг
// const users = [
//     {
//         _id: '12312asda',
//         firstName: 'Igor',
